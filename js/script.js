...
/* ========= Dark Mode ========*/
//Pegando os elementos e colocando em variávies
const btnTheme = document.querySelector('.btn-toggle')
const imgTheme =  document.querySelectorAll('.btn-toggle img')//[img.moon.active, img.sun]


//Adicionando/removendo class dark-mode ao html
